...
public class Zone  {
    ...
    public Zone (Controllable controller,boolean isLockDown, boolean isWall, boolean isRestrictionMouvement,int nbZones)
    ...
    c'est à dire  nbmurs=nbZones-1 **/
        ...
        this.p = new Population(controller, controller.getPersonsCount(),isLockDown, isWall, isRestrictionMouvement,nbZones);
    }
